# PRAMBH — TryHackMe Room Specification (Blueprint)
...
- **Material Distribution:** Downloadable File (`prambh.zip.enc` + `MANIFEST.sha256`)
...
> *Before the Cartographer’s Ghost surveyed the silent heights, there was only the First Survey — PRAMBH.*
>
...
- **Answer Masks:** Auto-generated in TryHackMe editor; no hint field enabled.
